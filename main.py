...
canvas = Canvas(window,bg="white",bd=5,relief=RIDGE,height=700,width=1400)
...
color_frame.place(x=10,y=10,width=428,height=60)

tools = LabelFrame(window,text="Tool",relief=RIDGE,bg="white",font=("Harrington",15,"bold"))
tools.place(x=450,y=10,width=250,height=60)

stroke_size = LabelFrame(window,text="Size",relief=RIDGE,bg="white",font=("Harrington",15,"bold"))
stroke_size.place(x=710,y=10,width=250,height=65)


        #    red       green      blue       pink    yellow    orange  sky-color brown    white    black        grey  purple
colors =["#ff0000","#0d4b00","#0d14dc","#ff8fdc","#f2f542","#f57e42","#42e3f5","#964B00" ,"#FFFFFF","#000000","#808080","#6a0dad"]
...
canvas_color_btn = Button(tools , text="Canvas",bd=4,bg="white",command=canvas_color,relief=RIDGE)
canvas_color_btn.grid(row=0,column=0,padx=5)

save_btn = Button(tools, text="Save",bd=4,bg="white",command=Save,relief=RIDGE)
save_btn.grid(row=0,column=1,padx=1)



clear_btn = Button(tools, text="Clear",bd=4,bg="white",command=Clear,relief=RIDGE)
clear_btn.grid(row=0,column=2,padx=1)

erase_btn = Button(tools,  text="Erase",bd=4,bg="white",command=Erase,relief=RIDGE)
erase_btn.grid(row=0,column=3,padx=1)

color_pallate=Button(tools, text="Pallete",bd=4,bg="white",command=pallete,relief=RIDGE)
color_pallate.grid(row=0,column=4,padx=1)




brush_size = Scale(stroke_size, orient=HORIZONTAL,from_=0,to=50,length=230)
brush_size.set(1)
